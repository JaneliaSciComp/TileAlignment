...
echo "$CC align_tiles.c $INC $LIBS $CCOPT $OPTS $BLAS  -o align_tiles_pastix"

mpicc align_tiles.c /home/denisovg/lib64/libstdc++.so.6 $INC $LIBS $CCOPT $OPTS $BLAS  -o align_tiles_pastix
